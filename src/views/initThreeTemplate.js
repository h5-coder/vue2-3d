...
const mapImageList = [
  {
    id: 100,
    url: require(`./images/maps/5.jpg`)
  },
  {
    id: 99,
    url: require(`./images/maps/6.jpg`)
  },
  {
    id: 98,
    url: require(`./images/maps/7.jpg`)
  },
  {
    id: 97,
    url: require(`./images/maps/8.jpg`)
  },
  {
    id: 96,
    url: require(`./images/maps/9.jpg`)
  },
  {
    id: 95,
    url: require(`./images/maps/10.jpg`)
  },
  {
    id: 94,
    url: require(`./images/maps/11.png`)
  },
  {
    id: 93,
    url: require(`./images/maps/12.jpg`)
  },
  {
    id: 92,
    url: require(`./images/maps/13.jpg`)
  },
  {
    id: 91,
    url: require(`./images/maps/14.png`)
  },
  {
    id: 90,
    url: require(`./images/maps/16.jpg`)
  },
  {
    id: 89,
    url: require(`./images/maps/17.jpg`)
  },
  {
    id: 88,
    url: require(`./images/maps/18.jpg`)
  },
  {
    id: 87,
    url: require(`./images/maps/19.jpg`)
  },
]
/**
 * 计算光源垂直和水平方向的定位
...
class renderModel {
	constructor(config, elementId) {
		...
		this.container = typeof elementId=='string'? document.querySelector('#' + elementId):elementId
		// 相机
		this.camera
		// 场景
		this.scene
	...
	setSceneLight() {
		...
		if (light.spotLight) {
			...
			spotLight.map = new THREE.TextureLoader().load(require('./images/model-bg-1.jpg'));
			spotLight.decay = 2;
